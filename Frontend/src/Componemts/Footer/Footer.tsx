...
const Footer = () => {
  ...
  return location.pathname !== "/signup" && location.pathname !== "/login" ? (
    <div className="bg-darkColor-900 pt-10 pb-5 px-4 md:px-8 lg:px-12 font-['Poppins']">
      <div className="flex flex-col md:flex-row gap-8 md:gap-5 lg:gap-10 justify-between max-w-7xl mx-auto">
        ...
        <div className="w-full md:w-1/2 lg:w-1/4 flex flex-col gap-4">
          ...
          <div className="text-mine-shaft-300 text-xs sm:text-sm">
            Job portal with user profile, job search, job posting, and
            application
          </div>

          <div className="flex gap-3 text-primaryColor-500 [&>div]:bg-mine-shaft-900 [&>div]:p-2 [&>div]:rounded-full hover:[&>div]:cursor-pointer hover:[&>div]:bg-mine-shaft-700">
            <div>
