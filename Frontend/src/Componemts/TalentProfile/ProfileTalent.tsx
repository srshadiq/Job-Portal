  ...
  return (
    <div className="w-full lg:w-2/3">
      ...
      <div className="px-2 xsm:px-3 mt-12 xsm:mt-16 pt-2">
        ...
        <div className="flex gap-1 text-mine-shaft-300 text-sm xsm:text-base md:text-lg items-center mt-1">
      ...
      <div className="px-2 xsm:px-3">
        ...
        <div className="text-sm xsm:text-base text-mine-shaft-300 text-justify leading-relaxed">
          {profile?.about}
        </div>
      </div>
      ...
      <div className="px-2 xsm:px-3">
        ...
        <div className="flex flex-wrap gap-1 xsm:gap-2">
          {profile?.skills?.map((skill: any, index: any) => (
            <div
              key={index}
              className="text-xs xsm:text-sm font-medium bg-mine-shaft-950 border-opacity-15 
