    ...
    <>
      ...
      <div className="md:hidden w-full px-4 xsm:px-6 xs:px-8 sm:px-12 flex flex-col justify-center gap-3 py-8 min-h-[60vh]">
        ...
        >
          <Group mt="xs" className="flex-col xs:flex-row gap-2">
            <Radio
              className="w-full xs:w-auto px-4 py-3 rounded-lg border hover:bg-mine-shaft-950/30 has-[:checked]:border-primaryColor-500 border-mine-shaft-800"
              value="APPLICANT"
              label="Applicant"
            />
            <Radio
      ...
      <div className="hidden md:flex w-1/2 px-8 lg:px-12 xl:px-20 flex-col justify-center gap-3 lg:gap-4">
        ...
        >
          <Group mt="xs">
            <Radio
              className="px-4 lg:px-6 py-3 lg:py-4 rounded-lg border hover:bg-mine-shaft-950/30 has-[:checked]:border-primaryColor-500 border-mine-shaft-800"
              value="APPLICANT"
              label="Applicant"
            />
            <Radio
