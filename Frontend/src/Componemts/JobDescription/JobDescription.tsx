    ...
    <div className="w-full">
      ...
      <div className="flex flex-col sm:flex-row justify-between gap-4 sm:gap-2">
        <div className="flex gap-2 sm:gap-3 items-start sm:items-center">
          <div className="p-2 sm:p-3 bg-mine-shaft-800 rounded-xl flex-shrink-0">
            <img
          ...
          <div className="flex flex-col gap-1 min-w-0 flex-1">
            ...
            <div className="text-sm sm:text-base lg:text-lg text-mine-shaft-300 flex flex-wrap gap-1">
        ...
        <div className="flex flex-row sm:flex-col gap-2 items-center justify-end sm:justify-start">
          ...
          {props.edit && !props.closed ? (
            ...
            <IconBookmark
              onClick={handleSavedJob}
              className="text-mine-shaft-300 cursor-pointer hover:text-primaryColor-500 h-6 w-6"
            />
          )}
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 xs:grid-cols-4 md:grid-cols-4 lg:grid-cols-5 gap-3 sm:gap-4">
        {card.map((item: any, index: number) => (
          ...
          >
            ...
            <div className="text-xs sm:text-sm text-mine-shaft-300 leading-tight">
              {item.name}
            </div>
      ...
      <div
        className="[&_h4]:text-lg [&_h4]:sm:text-xl [&_*]:text-mine-shaft-300 [&_h4]:my-3 [&_h4]:sm:my-5 [&_h4]:text-mine-shaft-200 [&_h4]:font-semibold [&_p]:text-justify [&_p]:text-sm [&_p]:sm:text-base [&_li]:marker:text-primaryColor-500 [&_li]:mb-1 [&_li]:text-sm [&_li]:sm:text-base"
      ...
      <div>
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-3 sm:gap-2 mb-3">
          <div className="flex gap-2 sm:gap-3 items-center">
            ...
            <div className="flex flex-col">
              ...
              <div className="text-sm sm:text-base text-mine-shaft-300">
                10k+ Employees
              </div>
            </div>
          </div>
        ...
        <div className="text-mine-shaft-300 text-justify text-sm sm:text-base leading-relaxed">
