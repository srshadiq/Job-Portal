...
const TalentCard = (props: any) => {
  ...
  return (
    <div className="bg-mine-shaft-950 p-4 min-w-[200px] transition duration-300 ease-in-out w-80 flex flex-col gap-3 rounded-xl flex-grow hover:shadow-[0_0_5px_1px_blue] !shadow-primaryColor-500 ">
      ...
      {props.invited ? (
        <div className="flex gap-1 text-mine-shaft-300 text-sm items-center">
