...
const MultiSelectSearch = (props: any) => {
    ...
    >
      <Combobox.DropdownTarget>
        <PillsInput
          ...
          leftSection={
            <div className="text-primaryColor-600 theme-bg-secondary p-1 rounded-full mr-2">
              <props.icon />
            </div>
          }
        ...
        >
          <Pill.Group>
            {value.length > 0 ? (
              ...
              <Input.Placeholder className="theme-text-tertiary">
                {props.title}
              </Input.Placeholder>
            )}
          </Pill.Group>
