  ...
  return (
    <div className="flex items-center justify-center px-16 h-[calc(100vh-5rem)] mt-0 md-mx:flex-col md-mx:px-6 md-mx:py-8 md-mx:h-auto md-mx:min-h-[calc(100vh-5rem)]">
      <div className="flex flex-col w-[45%] gap-3 md-mx:w-full md-mx:text-center md-mx:order-2 md-mx:mt-8">
        <div className="text-6xl leading-tight font-bold text-mine-shaft-100 [&>span]:text-primaryColor-500 md-mx:text-4xl sm-mx:text-3xl xs-mx:text-2xl">
          Find your <span>dream</span> <span>job</span> with us
        </div>
        <div className="text-mine-shaft-200 text-lg md-mx:text-base sm-mx:text-sm">
        ...
        <div className="flex gap-3 mt-5 md-mx:flex-col md-mx:gap-4 sm-mx:mt-4">
          <TextInput
            className="bg-mine-shaft-900 rounded-lg p-1 px-2 text-mine-shaft-100 [&_input]:!text-mine-shaft-100 md-mx:w-full"
            variant="unstyled"
            label="Job Title"
          ...
          />
          <div
            className="flex items-center justify-center h-full w-20 bg-primaryColor-600 text-mine-shaft-100 rounded-lg p-2 hover:bg-primaryColor-700 cursor-pointer md-mx:w-full md-mx:h-12 md-mx:mt-2 transition-colors duration-200"
