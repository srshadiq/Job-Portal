...
const SignUpPage = () => {
  ...
  return (
    <div className="min-h-[90vh] bg-darkColor-950 font-['Poppins'] overflow-hidden relative">
      <Button
        onClick={() => navigate("/")}
      ...
      <div className="md:hidden w-full h-full flex flex-col">
        {location.pathname === "/signup" ? (
          <>
            ...
            <div className="w-full py-8 px-4 bg-darkColor-900 flex flex-col justify-center items-center gap-3">
              ...
              <div className="text-mine-shaft-200 font-semibold text-sm xsm:text-base xs:text-lg text-center">
      ...
      >
        ...
        <div
          ...
          } bg-darkColor-900 flex flex-col justify-center items-center gap-3 lg:gap-5`}
        >
          ...
          <div className="text-mine-shaft-200 font-semibold text-lg lg:text-xl xl:text-2xl text-center px-4">
            Find the job made for you
          </div>
        </div>
        <SignUp />
